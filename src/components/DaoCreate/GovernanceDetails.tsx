    ...
    <div>
      ...
      <InputBox>
        <Input
          ...
          label="Voting Period"
          unit="Blocks"
          helperText="How many Blocks is the proposals voting period
      ...
      <InputBox>
        <Input
          ...
          label="Quorum"
          unit="%"
          helperText="The percentage of total votes / total tokens required in order for a proposal to PASS. Recommend: 4%"
        />
      </InputBox>
      <InputBox>
        <Input
          ...
          by ensuring there is always time for other voters to be reached and try to oppose the decision.
          Recommend: 0 Blocks"
        />
      </InputBox>
      <InputBox>
      ...
      <ContentBanner description="The Governance Setup values are editable at this time. A default value has been placed input box. To change these values, a new proposal will need to be created and passed by your members." />
    </div>
  );
}
