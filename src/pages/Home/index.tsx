    ...
    <div>
      ...
      <ContentBox title="What path will you take?">
        <div className="md:grid md:grid-cols-2 gap-6 flex flex-col items-center py-4">
          <Link to="/daos/new" className="w-full">
            <PrimaryButton label="Create a Fractal" isLarge className="w-full"/>
          </Link>
          <Link to="/daos" className="w-full">
            <SecondaryButton label="Find a Fractal" isLarge className="w-full"/>
          </Link>
        </div>
      </ContentBox>
    </div>
