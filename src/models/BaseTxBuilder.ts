...
import { BaseContracts, AzoriusContracts, GnosisDAO, AzoriusGovernanceDAO, SubDAO } from '../types';
...
export class BaseTxBuilder {
  ...
  protected readonly daoData: GnosisDAO | AzoriusGovernanceDAO | SubDAO;
