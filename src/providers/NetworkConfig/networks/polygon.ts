...
export const polygonConfig: NetworkConfig = {
  ...
  contracts: {
    ...
    fallbackHandler: {
      address: fallbackHandler.networkAddresses[polygon.id.toString()]! as Address,
      abi: fallbackHandler.abi as Abi,
    },
    safe: {
      address: safe.networkAddresses[polygon.id.toString()]! as Address,
      abi: safe.abi as Abi,
    },
    safeFactory: {
      address: safeFactory.networkAddresses[polygon.id.toString()] as Address,
    ...
    multisend: {
      address: multiSendCallOnly.networkAddresses[polygon.id.toString()]! as Address,
