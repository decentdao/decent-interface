...
export interface VotesTokenWithSupplyInterface extends utils.Interface {
  functions: {
...
export interface VotesTokenWithSupply extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VotesTokenWithSupplyInterface;
