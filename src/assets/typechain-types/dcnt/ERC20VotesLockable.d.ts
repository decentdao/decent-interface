...
interface ERC20VotesLockableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setUpLockedVotingPower(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setUpLockedVotingPower",
    values: [string]
  ): string;
...
export class ERC20VotesLockable extends BaseContract {
  ...
  interface: ERC20VotesLockableInterface;
