...
export interface GovTimelockUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface GovTimelockUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovTimelockUpgradeableInterface;
