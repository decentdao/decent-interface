...
export interface GovernorTimelockInterface extends utils.Interface {
  functions: {
...
export interface GovernorTimelock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorTimelockInterface;
