...
export interface IAccessControlDAOInterface extends utils.Interface {
  functions: {
...
export interface IAccessControlDAO extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAccessControlDAOInterface;
