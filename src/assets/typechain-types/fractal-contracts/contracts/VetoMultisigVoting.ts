...
export interface VetoMultisigVotingInterface extends utils.Interface {
  functions: {
...
export interface VetoMultisigVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VetoMultisigVotingInterface;
