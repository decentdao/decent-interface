...
export interface FractalBaseGuardInterface extends utils.Interface {
  functions: {
...
export interface FractalBaseGuard extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FractalBaseGuardInterface;
