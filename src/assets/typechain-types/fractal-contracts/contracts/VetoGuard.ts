...
export interface VetoGuardInterface extends utils.Interface {
  functions: {
    ...
    "updateExecutionDelayBlocks(uint256)": FunctionFragment;
    "vetoVoting()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "updateExecutionDelayBlocks",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "vetoVoting",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "vetoVoting", data: BytesLike): Result;
...
export interface VetoGuard extends BaseContract {
  ...
  functions: {
    ...
    updateExecutionDelayBlocks(
      _executionDelayBlocks: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    vetoVoting(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ...
    vetoVoting(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    vetoVoting(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
