...
export interface SimpleMemberVotingInterface extends utils.Interface {
  functions: {
...
export interface SimpleMemberVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleMemberVotingInterface;
