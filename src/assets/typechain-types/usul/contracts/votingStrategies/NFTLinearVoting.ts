...
export interface NFTLinearVotingInterface extends utils.Interface {
  functions: {
...
export interface NFTLinearVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTLinearVotingInterface;
