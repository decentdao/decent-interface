...
export interface MemberLinearVotingInterface extends utils.Interface {
  functions: {
    "UsulModule()": FunctionFragment;
    "VOTE_TYPEHASH()": FunctionFragment;
    "addMember(address)": FunctionFragment;
    "calculateWeight(address,uint256)": FunctionFragment;
...
export interface MemberLinearVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MemberLinearVotingInterface;
