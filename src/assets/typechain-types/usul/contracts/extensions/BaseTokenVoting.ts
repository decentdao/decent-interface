...
export interface BaseTokenVotingInterface extends utils.Interface {
  functions: {
...
export interface BaseTokenVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseTokenVotingInterface;
