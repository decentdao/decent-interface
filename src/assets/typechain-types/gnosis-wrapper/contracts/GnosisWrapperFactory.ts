...
export interface GnosisWrapperFactoryInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "GnosisWrapperCreated(address)": EventFragment;
    "Initialized(uint8)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "VersionCreated(string,string,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "GnosisWrapperCreated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Initialized"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "VersionCreated"): EventFragment;
}

export interface GnosisWrapperCreatedEventObject {
  gnosisSafe: string;
}
export type GnosisWrapperCreatedEvent = TypedEvent<
  [string],
  GnosisWrapperCreatedEventObject
>;

export type GnosisWrapperCreatedEventFilter =
  TypedEventFilter<GnosisWrapperCreatedEvent>;
...
export interface GnosisWrapperFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GnosisWrapperFactoryInterface;
  ...
  filters: {
    "GnosisWrapperCreated(address)"(
      gnosisSafe?: null
    ): GnosisWrapperCreatedEventFilter;
    GnosisWrapperCreated(gnosisSafe?: null): GnosisWrapperCreatedEventFilter;
