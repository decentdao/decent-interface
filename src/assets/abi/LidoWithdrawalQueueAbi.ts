const LidoWithdrawalQueueAbi = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_amountOfStETH', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: '_sinceTimestamp', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: '_admin', type: 'address' }],
    name: 'InitializedV1',
    type: 'event',
  },
  {
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'nftDescriptorAddress', type: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'owner', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'amountOfStETH', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'amountOfShares', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'amountOfETHLocked', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'sharesToBurn', type: 'uint256' },
  ...
  },
  {
    inputs: [
      ...
      {
        components: [
          { internalType: 'uint256', name: 'remainingEthBudget', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_lastRequestIdToBeFinalized', type: 'uint256' },
      { internalType: 'uint256', name: '_maxShareRate', type: 'uint256' },
    ],
    name: 'finalize',
    outputs: [],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256[]', name: 'claimableEthValues', type: 'uint256[]' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_bunkerStartTimestamp', type: 'uint256' },
      { internalType: 'uint256', name: '_currentReportTimestamp', type: 'uint256' },
    ],
    name: 'onOracleReport',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_pauseUntilInclusive', type: 'uint256' }],
    name: 'pauseUntil',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: '_nftDescriptorAddress', type: 'address' }],
...
export default LidoWithdrawalQueueAbi;
