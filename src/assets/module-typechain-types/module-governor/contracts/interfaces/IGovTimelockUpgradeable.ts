...
export interface IGovTimelockUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface IGovTimelockUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGovTimelockUpgradeableInterface;
