...
interface VotesTokenWrappedInterface extends ethers.utils.Interface {
  functions: {
...
export class VotesTokenWrapped extends BaseContract {
  ...
  interface: VotesTokenWrappedInterface;
