...
interface BravoGovernorInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(string,address,address,uint64,uint256,uint256,uint256,uint256)": FunctionFragment;
...
export class BravoGovernor extends BaseContract {
  ...
  interface: BravoGovernorInterface;
